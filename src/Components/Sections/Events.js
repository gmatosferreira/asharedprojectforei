        ...
        <section id="campanha">
            <div className="d-flex flex-column col col-md-9 mx-auto py-5">
                <img 
                    ...
                    src={process.env.PUBLIC_URL + '/images/titles/events.png'} 
                    alt="A semana de campanha"
                />
                <img 
                    className="title-4 mx-auto my-3 mb-5" 
                    src={process.env.PUBLIC_URL + '/images/titles/eventssub.png'} 
                    alt="De 23 a 27 de novembro"
                />
